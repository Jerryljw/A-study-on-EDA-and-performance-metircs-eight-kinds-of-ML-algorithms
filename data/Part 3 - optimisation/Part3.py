...
def load_data():
    ...
    """
    #df=pd.read_csv("Part2.csv") #uncomment it to read the file without outliers
    df = pd.read_csv("Part2Outliers.csv")
    return df
...
if __name__ == '__main__':
    # Settings
    metric_type = "MAE"  # MSE, RMSE, MAE, R2, modify it to change metric type
    optimizer_type = "PSO"  # PSO, BGD MiniBGD,modify it to change optimizer type
